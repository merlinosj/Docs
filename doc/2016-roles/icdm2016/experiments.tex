...
\synth, the synthetic data.  In Figure~\ref{fig:synth}, we plot 
{\em adjusted Rand index} for each method as a function of noise level.  
...
the two classes. We construct alternative partitioning based on the seniority of the job title:
...
The adjusted Rand index was $0.387$.\footnote{Value 1 means complete agreement, 
